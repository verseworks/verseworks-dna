...
Our primary metric is the {{ site.company_name }} Happiness Index. It's the only thing we systemically measure and follow up. Scale is 1-5. The data lives in our "dashboard":dashboard.html (a shared Google spreadsheet).
