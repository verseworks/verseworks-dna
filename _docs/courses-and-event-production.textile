...
* {{site.company_name}} role is to be the "platform", providing things such as administrative support (invoices, lunch reservation, email communication, registration page, etc). The Producer will arrange .  Sometimes we partner with more established companies to provide these things and assist with marketing.
...
# Tarquin opens the {{site.company_name}} calendar on Google, finds an open slot Feb 12-13, and writes "LOKAL: Agile Engineering course (Tarquin)". (LOKAL means "venue" in Swedish, our convention for booking different parts of the office)
